...
GX_ICON_PROPERTIES window2_yuki_icon_properties =
{
    GX_PIXELMAP_ID_YUKI_ICON,                /* normal pixelmap id             */
    GX_PIXELMAP_ID_YUKI_ICON                 /* selected pixelmap id           */
};

GX_CONST GX_STUDIO_WIDGET window2_yuki_icon_define =
{
    "yuki_icon",
    ...
    {56, 6, 183, 133},                       /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW2_CONTROL_BLOCK, window2_yuki_icon), /* control block       */
    (void *) &window2_yuki_icon_properties   /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window2_window2_text_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {80, 285, 159, 308},                     /* widget size                    */
    &window2_yuki_icon_define,               /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
